    ...
    class LoginCustomizer
    {
        ...
        public function remove_customizer_settings_for_block_theme( $WP_Customize_Manager ){
            ...
            if (isset($WP_Customize_Manager->widgets) && is_object($WP_Customize_Manager->widgets)) {
                remove_action( 'customize_controls_print_footer_scripts', array( $WP_Customize_Manager->widgets, 'output_widget_control_templates' ) );
            }
        }
        ...
        public function jltwp_adminify_preview_styles()
        {
            ...
            wp_enqueue_style('wp-adminify-login-customizer-preview', $this->url . '/assets/css/preview.css', array(), WP_ADMINIFY_VER, 'all');
        }
